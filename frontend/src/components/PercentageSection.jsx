            ...
            <div className="text-4xl font-bold grid gap-3 p-4 lilita-one-regular">
                <div className="flex items-center">
                    <div className="relative flex items-center text-center border-6 border-black w-[50%] h-[85px] m-auto bg-white  rounded-full">
                        <div className="flex items-center justify-evenly w-full">
                            <span className=" h-[55px] w-[55px] bg-black text-white flex justify-center items-center rounded-full">
                                50
                            </span>
                            <span>
                                <img
                        ...
                        <div className="absolute w-full -top-9 flex items-center text-white">
                            <div className="w-[50%] text-[24px] flex flex-col text-center items-center">
                                <span className="relative top-1 text-[14px] w-[35px] text-white texts-shadow text-shadow-black rounded-tl-md rounded-tr-md">
                                    MIN
                                </span>
                                <span className="w-[120px] bg-black/20 shadow shadow-gray-700 rounded-full text-shadow-md text-shadow-black">
                                    ₱ {Number(tableInfo[0]?.fiftywhite_min).toLocaleString()}
                                </span>
                            </div>
                            <div className="w-[50%] text-[24px] flex flex-col text-center items-center">
                                <span className="relative top-1 text-[14px] w-[35px] text-white  texts-shadow text-shadow-black rounded-tl-md rounded-tr-md">
                                ...
                                <span className="w-[120px] bg-black/20 shadow shadow-gray-700 rounded-full text-shadow-md text-shadow-black">
                                    ₱ {Number(tableInfo[0]?.fiftywhite_max).toLocaleString()}
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className="relative flex items-center text-center border-6 border-white w-[50%] h-[85px]  m-auto bg-black text-white  rounded-full">
                        <div className="flex items-center justify-evenly w-full">
                            <span className="h-[55px] w-[55px] bg-white text-black flex justify-center items-center rounded-full">
                                50
                            </span>
                            <span>
                                <img
                        ...
                        <div className="absolute text-white w-full -top-9 flex items-center">
                            <div className="w-[50%] text-[24px] flex flex-col text-center items-center">
                                <span className="relative top-1 text-[14px] w-[35px] text-white texts-shadow text-shadow-black">
                                    MIN
                                </span>
                                <span className="w-[120px] bg-black/20 shadow shadow-gray-700 rounded-full text-shadow-md text-shadow-black">
                                    ₱ {Number(tableInfo[0]?.fiftywhite_min).toLocaleString()}
                ...
                <div className=" text-center flex items-center border-6 border-red-200 h-[85px] w-[100%] m-auto bg-red-500 text-white  rounded-full overflow-hidden relative">
                    <div className="flex items-center justify-between px-6 w-[50%]">
                        <span className="z-30 text-shadow h-[55px] w-[55px] bg-red-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
                            25
                        </span>
                        <span className="z-30">
                            <img
                                className={`h-[65px] ${customizeRemovePercentage(initResultCount(25)) >= 50
                                    ? "animate-bounce"
                                    : null
                                    }`}
                                src={red}
                    ...
                    <div className="w-[50%] flex items-center drop-shadow-md drop-shadow-black text-white">
                        ...
                        <div className="w-full text-[28px] flex flex-col text-left">
                            <span>
                                ₱ {Number(tableInfo[0]?.twentyFive_min).toLocaleString()}
                            </span>
                            <span>
                                ₱ {Number(tableInfo[0]?.twentyFive_max).toLocaleString()}
                            </span>
                        </div>
                    </div>
                </div>
                <div className="text-center flex items-center border-6 border-yellow-200 h-[85px] w-[100%] m-auto bg-yellow-500 text-white  rounded-full overflow-hidden relative">
                    <div className="flex items-center justify-between px-6 w-[50%]">
                        <span className="z-20 text-shadow h-[55px] w-[55px] bg-yellow-400 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
                            10
                        </span>
                        <span className="z-20">
                            <img
                                className={`h-[65px] ${customizeRemovePercentage(initResultCount(10)) >= 50
                                    ? "animate-bounce"
                                    : null
                                    }`}
                                src={yellow}
                ...
                <div className="text-center flex items-center border-6 border-blue-200 h-[85px] w-[100%] m-auto bg-blue-500 text-white  rounded-full overflow-hidden relative">
                    <div className="flex items-center justify-between px-6 w-[50%]">
                        <span className="z-20 text-shadow h-[55px] w-[55px] bg-blue-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
                            5
                        </span>
                        <span className="z-20">
                            <img
                                className={`h-[65px] ${customizeRemovePercentage(initResultCount(5)) >= 50
                                    ? "animate-bounce"
                                    : null
                                    }`}
                                src={blue}
                ...
                <div className="text-center flex items-center border-6 border-pink-200 h-[85px] w-[100%] m-auto bg-pink-500 text-white  rounded-full overflow-hidden relative">
                    <div className="flex items-center justify-between px-6 w-[50%]">
                        <span className="z-20 text-shadow h-[55px] w-[55px] bg-pink-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
                            3
                        </span>
                        <span className="z-20">
                            <img
                                className={`h-[65px] ${customizeRemovePercentage(initResultCount(3)) >= 50
                                    ? "animate-bounce"
                                    : null
                                    }`}
                                src={pink}
                ...
                <div>
                    <div className="text-center flex items-center border-6 border-orange-200 h-[85px] w-[100%] m-auto bg-orange-500 text-white rounded-full overflow-hidden relative">
                        <div className="flex items-center justify-between px-6 w-[50%]">
                            <span className="z-20 text-shadow h-[55px] w-[55px] bg-orange-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
                                1
                            </span>
                            <span className="z-20">
                                <img
                                    className={`h-[65px] ${customizeRemovePercentage(initResultCount(1)) >= 50
                                        ? "animate-bounce"
                                        : null
                                        }`}
                                    src={white}
