...
function PercentageSection() {
  ...
  const initPercentage = useCallback(
    (num) => {
      ...
      <div className="text-4xl font-bold grid gap-5 p-4 poppins-extrabold">
        <div className="flex gap-x-4">
          <div className="flex items-center justify-evenly text-center border-6 border-black w-[48%]  h-[125px]  m-auto bg-white  rounded-full">
            <span className=" h-[75px] w-[75px] bg-black text-white flex justify-center items-center rounded-full">
              50
            </span>
            <span>
              <img
          ...
          <div className=" flex items-center justify-evenly text-center border-6 border-white w-[48%] h-[125px]  m-auto bg-black text-white  rounded-full">
            <span className="h-[75px] w-[75px] bg-white text-black flex justify-center items-center rounded-full">
              50
            </span>
            <span>
              <img
        ...
        <div className=" text-center flex items-center justify-evenly border-6 border-red-200 h-[125px] w-[100%] m-auto bg-red-500 text-white  rounded-full overflow-hidden relative">
          <span className="z-30 text-shadow h-[75px] w-[75px] bg-red-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
            25
          </span>
          <span className="z-30">
            <img
              className={`h-[90px] ${
                customizeRemovePercentage(initPercentage(25)) >= 50
                  ? "animate-bounce"
                  : null
              }`}
              src={red}
        ...
        <div className="text-center flex items-center justify-evenly border-6 border-yellow-200 h-[125px] w-[100%] m-auto bg-yellow-500 text-white  rounded-full overflow-hidden relative">
          <span className="z-20 text-shadow h-[75px] w-[75px] bg-yellow-400 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
            10
          </span>
          <span className="z-20">
            <img
              className={`h-[90px] ${
                customizeRemovePercentage(initPercentage(10)) >= 50
                  ? "animate-bounce"
                  : null
              }`}
              src={yellow}
        ...
        <div className="text-center flex items-center justify-evenly border-6 border-blue-200 h-[125px] w-[100%] m-auto bg-blue-500 text-white  rounded-full overflow-hidden relative">
          <span className="z-20 text-shadow h-[75px] w-[75px] bg-blue-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
            5
          </span>
          <span className="z-20">
            <img
              className={`h-[90px] ${
                customizeRemovePercentage(initPercentage(5)) >= 50
                  ? "animate-bounce"
                  : null
              }`}
              src={blue}
        ...
        <div className="text-center flex items-center justify-evenly border-6 border-pink-200 h-[125px] w-[100%] m-auto bg-pink-500 text-white  rounded-full overflow-hidden relative">
          <span className="z-20 text-shadow h-[75px] w-[75px] bg-pink-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
            3
          </span>
          <span className="z-20">
            <img
              className={`h-[90px] ${
                customizeRemovePercentage(initPercentage(3)) >= 50
                  ? "animate-bounce"
                  : null
              }`}
              src={pink}
        ...
        <div>
          <div className="text-center flex items-center justify-evenly border-6 border-orange-200 h-[125px] w-[100%] m-auto bg-orange-500 text-white rounded-full overflow-hidden relative">
            <span className="z-20 text-shadow h-[75px] w-[75px] bg-orange-600 shadow-md shadow-black text-white flex justify-center items-center rounded-full">
              1
            </span>
            <span className="z-20">
              <img
                className={`h-[90px] ${
                  customizeRemovePercentage(initPercentage(1)) >= 50
                    ? "animate-bounce"
                    : null
                }`}
                src={white}
