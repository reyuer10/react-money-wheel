...
function TableInformation() {
  const { fastNumInterval, count, setCount } = useContext(MoneyWheelContext);
    ...
    () => [
      {
        ...
        numberImage: white,
        numBorderStyle:
          "bg-orange-600 rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 1,
        number: 3,
        ...
        numberImage: pink,
        numBorderStyle:
          "bg-pink-600 rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 2,
        number: 5,
        ...
        numberImage: blue,
        numBorderStyle:
          "bg-blue-600 rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 3,
        number: 10,
        ...
        numberImage: yellow,
        numBorderStyle:
          "bg-yellow-600 rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 4,
        number: 25,
        ...
        numberImage: red,
        numBorderStyle:
          "bg-red-600 rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 5,
        number: 51,
        ...
        numberImage: null,
        numBorderStyle:
          "text-black bg-white rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
      {
        numberId: 6,
        number: 52,
        ...
        numberImage: null,
        numBorderStyle:
          "bg-black rounded-full h-[80px] w-[80px] shadow-md shadow-black flex justify-center items-center",
      },
    ],
    []
  );
  ...
  return (
    <div className="text-[45px] font-bold">
      <div className="bg-pink-500 shadow-md shadow-black w-[80px] h-[80px] z-30 absolute left-[450px] wheel-pointer"></div>
      ...
      >
        <div className="bg-white w-[150px] h-[150px] shadow-lg shadow-black  -rotate-27 p-4 border-6 border-pink-500 ring-4 ring-pink-700 rounded-full z-30 absolute left-[42%] top-[42%] flex justify-center items-center">
          <img src={casinoStotsenbergBlack} alt="casinoStotsenbergBlack" />
        </div>
        {num.map((n, index) => {
          return (
            <div
            ...
            >
              <li
                className={`list-none absolute top-8 left-8 z-30 w-[15px] h-[15px] bg-[#ffffff] shadow-2xl shadow-yellow-300 light-drop-shadow animate-pulse rounded-full`}
              ></li>
              <li
                className={`
                                ${n.inputNum == 51 ? "right-2" : "right-8 "}
                                list-none absolute top-6 z-30 w-[15px] h-[15px] bg-[#ffffff] shadow-2xl shadow-yellow-300 light-drop-shadow animate-pulse rounded-full`}
              ></li>
              <div className="relative top-10 left-2">
                <p
                  className={`-rotate-10 text-shadow
                                    ${n.inputNum == 51 ? "relative left-3" : ""}
                                    ${CustomizeColorBorderBasedOnNum(
                                      n.inputNum
                                    )}`}
                >
                  {n.num}
                ...
                {n.inputNum == 51 ? (
                  <div className="relative -rotate-10 left-6 top-5">
                    <img
                      className="h-[25px]"
                      src={casinoStotsenbergWhite}
                      alt="casinoStotsenbergWhite"
                    />
                  </div>
                ) : null}
                {n.inputNum == 52 ? (
                  <div className="relative -rotate-10 left-4 top-5 ">
                    <img
                      className="h-[25px]"
                      src={casinoStotsenbergBlack}
                      alt="casinoStotsenbergBlack"
                    />
                  </div>
                ) : null}
              </div>
