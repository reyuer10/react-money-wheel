...
import casinoStotsenbergBlack from "../assets/cpLogoBlack.png";
import casinoStotsenbergWhite from "../assets/cpLogoWhite.png";
...
function SideSection() {
  ...
  const customizeColorBasedOnNum = useCallback((num) => {
    if (num == 52)
      return "bg-black border-6 border-black ring-2 ring-white text-shadow-side-section ";
    if (num == 51)
      return "bg-white border-6 border-black ring-2 ring-white text-shadow-side-section";
    if (num == 25)
      return "bg-gradient-to-r from-red-500 via-red-700 to-red-900 text-white text-shadow-side-section border-4 border-red-200 shadow-xl shadow-red-700";
    if (num == 10)
      return "bg-gradient-to-r from-yellow-500 via-yellow-600 to-yellow-800 text-white text-shadow-side-section border-4 border-yellow-200 shadow-xl shadow-yellow-700";
    if (num == 5)
      return " bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 bg-blue-600 text-white text-shadow-side-section border-4 border-blue-200 shadow-xl shadow-blue-700";
    if (num == 3)
      return "bg-gradient-to-r from-pink-500 via-pink-700 to-pink-900 text-white text-shadow-side-section border-4 border-pink-200 shadow-xl shadow-pink-700";
    if (num == 1)
      return "bg-gradient-to-r from-orange-500 via-orange-600 to-orange-900 text-white text-shadow-side-section border-4 border-orange-200 shadow-xl shadow-orange-700";
  }, []);

  const customizeImageByNum = useCallback((num) => {
    if (num == 52) return casinoStotsenbergWhite;
    if (num == 51) return casinoStotsenbergBlack;
          ...
          <div key={index}>
            {index == 0 ? (
              ...
              >
                  ...
                  <>
                    <div className="absolute -top-[250px] -bottom-[40px]">
                      <img
                        ...
                        src={customizeImageByNum(r.results_num)}
                        alt="character"
                      />
                    </div>
                ...
                <div
                  className={`
                                    ${
                                      r.results_num == 51 &&
                                      "text-white p-6 text-[100px] bg-black rounded-full"
                                    }
                                    ${
                                      r.results_num == 52 &&
                                      "text-black p-6 text-[100px] bg-white rounded-full"
                                    }
                                       ${
                                         r.results_num == 52 ||
                                         r.results_num == 51
              ...
              <motion.div
                ...
                className={`relative overflow-hidden text-[72px] ${customizeColorBasedOnNum(
                  r.results_num
                )} text-black h-[120px] flex justify-center items-center m-6 rounded-2xl`}
              >
                ...
                <div
                  className={`
                                    ${
                                      r.results_num == 52 &&
                                      " bg-white rounded-full p-3 text-[70px]  "
                                    }
                                    ${
                                      r.results_num == 51 &&
                                      "bg-black rounded-full p-3 text-[70px] text-white"
                                    } 
                                     ${
                                       r.results_num == 52 ||
                                       r.results_num == 51
